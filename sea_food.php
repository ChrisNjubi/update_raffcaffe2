    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <p>
                ...
                panko-crusted, flash fried sushi-grade ahi tuna patty, avocado, pickled cucumbers, caramel soy drizzle, sriracha aïoli, lettuce,
                vine-ripened tomato,
                toasted brioche bun (served rare)*
            </p>
            <ul>
                <li>Single-sh. 600</li>
                <li>Double-sh. 800</li>
