...
<div class="row">
    ...
    <div class="col-md-10">
        <img src="resources/juice%20header.jpg" alt="Avatar" class="image">
    </div>
    <div class="col-md-1"></div>
</div>
<br>
...
<div class="row">
    ...
    <div class="col-md-2 container dropdown">
        <img src="resources/eiliv-sonas-aceron-a2AFt1wESNc-unsplash.jpg" alt="avatar" class="image">
        <div class="middle">
            <div class="text">eiliv sonas aceron</div>
            <div class="dropdown-content">
                <a href="#">Large- Sh.1300</a>
                <a href="#">Medium- Sh.1000</a>
                <a href="#">Small- Sh.700</a>
            </div>
        </div>
    </div>
    <div class="col-md-2"></div>
    <div class="col-md-2 dropdown container">
        <img src="resources/eiliv-sonas-aceron-htmoLOGzoBs-unsplash.jpg" alt="avatar" class="image">
        <div class="middle">
            <div class="text">eiliv sonas aceron</div>
            <div class="dropdown-content">
                <a href="#">Large- Sh.1300</a>
    ...
    <div class="col-md-2"></div>
    <div class="col-md-2 dropdown container">
        <img src="resources/whitney-wright-TgQkxQc-t_U-unsplash.jpg" alt="avatar" class="image">
        <div class="middle">
            <div class="text">Whitney wright</div>
            <div class="dropdown-content">
                <a href="#">Large- Sh.1300</a>
                <a href="#">Medium- Sh.1000</a>
                <a href="#">Small- Sh.700</a>
