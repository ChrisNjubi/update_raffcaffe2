...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <img src="resources/Chicken%20Delight.jpg" alt="Avatar"class="image_2">
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-5">
            <h1>Chicken Delight</h1>
            <p>With Tomato Sauce, Chicken Meat, Chicken Salami,
                Chicken Loaf, Mushrooms, Capsicums, Onions, Mozzarella Cheese, Tomatoes.</p>
            <ul>
                <li>Large-sh.1300</li>
