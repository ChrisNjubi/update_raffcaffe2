...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <img src="resources/Triple%20Chicken.jpg" alt="Avatar"class="image_2">
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-5">
            <h1>Triple Chicken</h1>
            <p>With Thousand Island Sauce, Chicken Meat, Chicken Salami, Chicken Loaf, Mushrooms,
                Chicken Rolls, Onions, Mozzarella Cheese, Tomatoes.</p>
            <ul>
                <li>Large-sh.1300</li>
                <li>Medium-sh.1000</li>
                <li>Small-sh.700</li>
            </ul>
        </div>
        <div class="col-md-1"></div>
