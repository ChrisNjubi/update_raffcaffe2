...
<div class="row">
    ...
    <div class="col-md-10">
        <img src="resources/burger%20header.jpg" alt="Avatar"class="image">
    </div>
    <div class="col-md-1"></div>
</div>
<br>
...
<div class="row">
    ...
    <div class="col-md-2 container ">
        <img src="resources/Beef%20Burger.jpg" alt="Avatar" class="image">
        <div class="middle">
            <a class="text" href="beef_burger.php">Beef_Burger</a>
        </div>
    </div>
    <div class="col-md-2"></div>
    <div class="col-md-2 container">
        <img src="resources/Chicken%20Burger.jpg" alt="Avatar" class="image">
        <div class="middle">
            <a class="text" href="chicken_burger.php">Chicken_Burger</a>
        </div>
    </div>
    <div class="col-md-2"></div>
    <div class="col-md-2 container">
        <img src="resources/Sea%20Food.jpg" alt="Avatar" class="image">
        <div class="middle">
            <a class="text" href="sea_food.php">Sea_Food</a>
        </div>
    </div>
    <div class="col-md-1"></div>
</div>
